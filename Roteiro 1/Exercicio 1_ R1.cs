public class Pessoa
{
    ...
    public void Apresentar_Salario()
    {
        if (Cargo == "Estagiário")
        {
            Console.WriteLine($"Meu salário é de R$ 100,00.");
        }
        else if (Cargo == "Desenvolverdor")
        {
            Console.WriteLine($"Meu salário é de R$ 5.000,00.");
        }
        else if (Cargo == "Gerente")
        {
            Console.WriteLine($"Meu salário é de R$ 10.000,00.");
        }
